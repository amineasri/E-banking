...
public class BankAccountServiceImp implements  BankAccountService {
 ...
 private AccountOperationRepository accountOperationRepository;
   ...
   Customer customer=customerRepository.findById(customerId).orElse(null);
    ...
    @Override
    public List<CustomerDTO> searchCustomers(String keywoard) {
        return customerRepository.findByNameContaining(keywoard).stream().map(customer -> dtoMapper.fromCustomer(customer)).collect(Collectors.toList());
    }
}
